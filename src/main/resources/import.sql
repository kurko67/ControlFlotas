...
insert into vehiculos(anio, created_at, estado, km, marca, patente, tipo, ubicacion, updated_at, vencimiento_ruta, vencimiento_seguro, vencimiento_vtv,conductor_id) values(2015,"2024-04-10","ACTIVO",120222,"HILUX SRV","ABC12323","camioneta","Campos San Luis","2024-04-20","2024-08-28","2024-04-10","2024-02-28",3);
insert into vehiculos(anio, created_at, estado, km, marca, patente, tipo, ubicacion, updated_at, vencimiento_ruta, vencimiento_seguro, vencimiento_vtv,conductor_id) values(2015,"2024-04-10","ACTIVO",120222,"TORINO GP","ABC345","camioneta","Campos San Luis","2024-04-20","2024-08-28","2024-04-10","2024-02-28",3);
